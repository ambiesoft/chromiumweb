...
$DefaultPasswords['admin'] = pmcrypt('itmito');
$DefaultPasswords['edit'] = pmcrypt('itmito');
...
$EnableUpload = 1;
$UploadPermAdd = 0;
$DefaultPasswords['upload'] = pmcrypt('itmito');
$UploadMaxSize = 1 * 1024 * 1024;
...
register_beautifier('batch');
register_beautifier('cpp');
register_beautifier('csharp');
register_beautifier('dosbatch');
register_beautifier('html');
